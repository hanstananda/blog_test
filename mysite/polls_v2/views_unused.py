...
def results(request, question_id):
    question = get_object_or_404(Question, pk=question_id)
    return render(request, 'polls_v2/results.html', {'question': question})
...
def vote(request, question_id):
    ...
    try:
        ...
        return render(request, 'polls_v2/detail.html', {
            'question': question,
        ...
        return HttpResponseRedirect(reverse('polls_v2:results', args=(question.id,)))